...
macbook_air_13_chain: LLMChain = create_llm_chain(
    GPT4_MODEL_NAME, PREFIX % "macbook_air_13.txt", ["title", "content"]
)
macbook_pro_13_chain: LLMChain = create_llm_chain(
    GPT4_MODEL_NAME, PREFIX % "macbook_pro_13.txt", ["title", "content"]
)
macbook_pro_14_chain: LLMChain = create_llm_chain(
    GPT4_MODEL_NAME, PREFIX % "macbook_pro_14.txt", ["title", "content"]
)
macbook_pro_16_chain: LLMChain = create_llm_chain(
    GPT4_MODEL_NAME, PREFIX % "macbook_pro_16.txt", ["title", "content"]
)
macmini_chain: LLMChain = create_llm_chain(
    GPT4_MODEL_NAME, PREFIX % "macmini.txt", ["title", "content"]
)

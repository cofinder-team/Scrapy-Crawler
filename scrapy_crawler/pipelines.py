...
class PostgresPipeline:
    ...
    def process_item(self, item, spider):
        ...
        try:
            self.cur.execute("INSERT INTO macguider.raw_used_item (url, img_url, price, date, writer, title, content, source) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
                             (adapter["url"], adapter["img_url"], adapter["price"], adapter["date"], adapter["writer"], adapter["title"], adapter["content"], "중고나라"))
            self.db.commit()

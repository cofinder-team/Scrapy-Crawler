...
class ClassifyDog(scrapy.Spider):
    ...
    custom_settings = {
        "ITEM_PIPELINES": {
            ...
            "scrapy_crawler.DBWatchDog.Classify.iphone_pipelines.GenerationClassifierPipeline": 10,
            "scrapy_crawler.DBWatchDog.Classify.iphone_pipelines.ModelClassifierPipeline": 11,
            "scrapy_crawler.DBWatchDog.Classify.iphone_pipelines.StorageClassifierPipeline": 12,
            "scrapy_crawler.DBWatchDog.Classify.pipelines.UnusedClassifierPipeline": 13,
            "scrapy_crawler.DBWatchDog.Classify.pipelines.AppleCarePlusClassifierPipeline": 14,
            "scrapy_crawler.DBWatchDog.Classify.ipad_pipelines.IpadClassifyPipeline": 15,
            "scrapy_crawler.DBWatchDog.Classify.macbook_pipelines.MacbookClassifyPipeline": 16,
            "scrapy_crawler.DBWatchDog.Classify.iphone_pipelines.IphoneClassifyPipeline": 17,
            "scrapy_crawler.DBWatchDog.Classify.pipelines.PersistRawUsedItemPipeline": 18,
            "scrapy_crawler.DBWatchDog.Classify.pipelines.LabelingAlertPipeline": 19,
            "scrapy_crawler.DBWatchDog.Classify.pipelines.PersistDealPipeline": 20,
            "scrapy_crawler.DBWatchDog.Classify.pipelines.DealAlertPipeline": 21,
        },
    }
